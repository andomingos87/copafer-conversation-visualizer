...
- `copafer_v2/` — explain what lives here and when agents should edit it.
- `create_feedback_table_postgres.sql/` — explain what lives here and when agents should edit it.
- `css/` — explain what lives here and when agents should edit it.
- `DASHBOARD_PROPOSAL.md/` — explain what lives here and when agents should edit it.
- `DASHBOARD_SUMMARY.md/` — explain what lives here and when agents should edit it.
- `dashboard-example.html/` — explain what lives here and when agents should edit it.
- `FEEDBACK_API.md/` — explain what lives here and when agents should edit it.
